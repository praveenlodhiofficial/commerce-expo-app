...
export default function HexagonCard({
  ...
  return (
    <View className="items-center justify-center">
      <Svg width={width} height={height} viewBox="0 0 278 306" className="invert">
        <Defs>
          <ClipPath id="clip">
            <Path d={pathData} />
          </ClipPath>
      ...
      {Icon && (
        <View className="absolute bottom-28 h-full w-full items-center justify-end rounded-full bg-black/35">
          <Icon width={100} height={100} fill="#ffffff" className=""/>
        </View>
      )}
